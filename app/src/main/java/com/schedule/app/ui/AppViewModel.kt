    ...
    fun processCommand(raw: String) {
        ...
        when (cmd) {
            ...
            "vip" -> {
                ...
                if (arg.isEmpty()) {
                    ...
                    if (p != null) {
                        ...
                        cmdPrint("err", "⚠️ Нужно войти в аккаунт")
                    }
                } else {
                    cmdPrint("err", "⚠️ Неверный код VIP")
                }
            }
            "logout" -> {
                doLogout()
            ...
            "deleteaccount" -> {
                ...
                cmdPrint("err", "⚠️ Неизвестная команда: /$cmd  (введи /help)")
            }
        }
        consoleInput = ""
    }
